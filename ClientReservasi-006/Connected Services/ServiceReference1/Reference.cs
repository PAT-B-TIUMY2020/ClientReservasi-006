...
namespace ClientReservasi_006.ServiceReference1 {
    ...
    public interface IService1 {
        ...
        string pemesanan(string IDPemesanan, string NamaCustomers, string NoTelepon, int JumlahPemesanan, string IDLokasi);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/pemesanan", ReplyAction="http://tempuri.org/IService1/pemesananResponse")]
        System.Threading.Tasks.Task<string> pemesananAsync(string IDPemesanan, string NamaCustomers, string NoTelepon, int JumlahPemesanan, string IDLokasi);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/deletePemesann", ReplyAction="http://tempuri.org/IService1/deletePemesannResponse")]
        string deletePemesann(string IDPemesanan);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/deletePemesann", ReplyAction="http://tempuri.org/IService1/deletePemesannResponse")]
        System.Threading.Tasks.Task<string> deletePemesannAsync(string IDPemesanan);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/Pemesanan", ReplyAction="http://tempuri.org/IService1/PemesananResponse")]
        ClientReservasi_006.ServiceReference1.PemesananResponse Pemesanan1(ClientReservasi_006.ServiceReference1.PemesananRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/Pemesanan", ReplyAction="http://tempuri.org/IService1/PemesananResponse")]
        System.Threading.Tasks.Task<ClientReservasi_006.ServiceReference1.PemesananResponse> Pemesanan1Async(ClientReservasi_006.ServiceReference1.PemesananRequest request);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IService1Channel : ClientReservasi_006.ServiceReference1.IService1, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class Service1Client : System.ServiceModel.ClientBase<ClientReservasi_006.ServiceReference1.IService1>, ClientReservasi_006.ServiceReference1.IService1 {
        ...
        public string pemesanan(string IDPemesanan, string NamaCustomers, string NoTelepon, int JumlahPemesanan, string IDLokasi) {
            return base.Channel.pemesanan(IDPemesanan, NamaCustomers, NoTelepon, JumlahPemesanan, IDLokasi);
        }
        
        public System.Threading.Tasks.Task<string> pemesananAsync(string IDPemesanan, string NamaCustomers, string NoTelepon, int JumlahPemesanan, string IDLokasi) {
            return base.Channel.pemesananAsync(IDPemesanan, NamaCustomers, NoTelepon, JumlahPemesanan, IDLokasi);
        }
        ...
        public string deletePemesann(string IDPemesanan) {
            return base.Channel.deletePemesann(IDPemesanan);
        }
        
        public System.Threading.Tasks.Task<string> deletePemesannAsync(string IDPemesanan) {
            return base.Channel.deletePemesannAsync(IDPemesanan);
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        ClientReservasi_006.ServiceReference1.PemesananResponse ClientReservasi_006.ServiceReference1.IService1.Pemesanan1(ClientReservasi_006.ServiceReference1.PemesananRequest request) {
            return base.Channel.Pemesanan1(request);
        }
        
        public ServiceReservasi.Pemesanan[] Pemesanan1() {
            ClientReservasi_006.ServiceReference1.PemesananRequest inValue = new ClientReservasi_006.ServiceReference1.PemesananRequest();
            ClientReservasi_006.ServiceReference1.PemesananResponse retVal = ((ClientReservasi_006.ServiceReference1.IService1)(this)).Pemesanan1(inValue);
            return retVal.PemesananResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<ClientReservasi_006.ServiceReference1.PemesananResponse> ClientReservasi_006.ServiceReference1.IService1.Pemesanan1Async(ClientReservasi_006.ServiceReference1.PemesananRequest request) {
            return base.Channel.Pemesanan1Async(request);
        }
        
        public System.Threading.Tasks.Task<ClientReservasi_006.ServiceReference1.PemesananResponse> Pemesanan1Async() {
            ClientReservasi_006.ServiceReference1.PemesananRequest inValue = new ClientReservasi_006.ServiceReference1.PemesananRequest();
            return ((ClientReservasi_006.ServiceReference1.IService1)(this)).Pemesanan1Async(inValue);
        }
